            ...
            <div className='input-section'>
                ...
                <div className='input-sub'>
                    ...
                    <div className='input-buttons'>
                        ...
                        <span>
                            <img src={uparrow} alt='uparrow' className='uparrow' onClick={handleIncrement} />
                        <img src={downarrow} alt='downarrow' className='downarrow' onClick={handleDecrement} />
                        </span>
                    </div>
                ...
                <div className='input-sub'>
                    ...
                    />
                    <span>
                        <img src={uparrow} alt='uparrow' className='uparrow' onClick={handleIncrementhours} />
                        <img src={downarrow} alt='downarrow' className='downarrow' onClick={handleDecrementhours} />
                    </span>
                    </div>
                </div>
                <div className='input-sub'>
